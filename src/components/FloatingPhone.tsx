  ...
  return (
    <div
      ...
      <motion.div
        ...
        className="relative h-72 w-40 md:h-96 md:w-56 rounded-[24px] border-2 border-b-4 border-r-4 border-white border-l-neutral-200 border-t-neutral-200 bg-neutral-900 p-1 pl-[3px] pt-[3px]">
        <HeaderBar />
