...
export const projects = [
  {
    ...
    liveLink: "https://www.lubesurgeons.com",
    isLive: true,
    isOnGithub: true,
    technologies:
...
export const otherProjects: OtherProjects[] = [
  ...
  {
    id: 5,
    name: "EarthandSoulStore",
    description:
      "Ecommerce store for hand-crafted garments, lifestyle and unique fashion with exclusive collection of bespoke and special wears",
    technologies: "Wordpress • Woocommerce • Elementor",
    liveLink: "https://earthandsoulstore.com",
    isLive: true,
    isOnGithub: false,
  },
  {
